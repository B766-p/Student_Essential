...
String uploadDir = "C:\\Users\\prita\\OneDrive\\Documents\\NetBeansProjects\\student esensial\\web\\v";

// Maximum size allowed for uploaded files (in bytes)
int maxFileSize = 30 * 1024 * 1024; // 10MB
