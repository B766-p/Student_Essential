<%-- 
    Document   : intern
    Created on : 01-Apr-2024, 19:29:01
    Author     : DELL
--%>
...
<div class="container">
    ...
    <form action="#" method="post">
        ...
        <label><input type="radio" name="job_type" value="paid" required> paid</label>
        <label><input type="radio" name="job_type" value="unpaid" required> unpaid</label>
        ...
        if (rowsInserted > 0) {
            ...
            <script>
                window.onload = function() {
                    alert('intern Form submitted successfully!');
                };
            </script>
            <%
        } else {
           ...
           <script>
                window.onload = function() {
                    alert('intern Form submitted unsuccessfully!');
                };
            </script>
            <%
        }
