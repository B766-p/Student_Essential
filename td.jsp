<%-- 
    Document   : td
    Created on : 03-Apr-2024, 13:34:54
    Author     : DELL
--%>
...
<body>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="video.jsp">
                    ...
                    <span class="link-name">Add Technical Skills</span>
                </a></li>
                <li><a href="adds.jsp">
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <iframe id="iframe"src="p21.jsp" width="100%" height="500"></iframe>
        </div>
