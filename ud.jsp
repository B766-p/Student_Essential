...
<body>
    ...
    <nav>
        <div class="logo-name">
            ...
            <span class="logo_name">Student Essestial</span>
        </div>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="adds.jsp">
                    <i class="uil uil-estate"></i>
                    <span class="link-name">Add Notes/Syllabus/PYQs</span>
                </a></li>
                
                <li id="job2"><a href="job2.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">Job Opportunities</span>
                </a></li>
                <li><a href="tech.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">Learn your Technical Skills</span>
                </a></li>
<!--                <li id="inten"><a href="intern2.jsp">
                    <i class="uil uil-chart"></i>
...
<!--                <li id="iner"><a >
                ...
                <li id="job3"><a href="intern2.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">Internship</span>
                </a></li>
                <li><a href="pdf1.jsp">
                    <i class="uil uil-chart"></i>
                    <span class="link-name">Syllabus/notes /qustions</span>
                </a></li>
    ...
    <section class="dashboard">
        ...
        <div class="dash-content">
            <iframe id="iframe"src="p22.jsp" width="100%" height="500"></iframe>
        </div>
...
//    // Change the URL to the desired page
//    window.location.href = 'intern2.jsp';
//});
//navLinks.forEach(link => {
//            link.addEventListener("click", handleNavLinkClick);
//        });
//        // JavaScript to handle the click event
//      document.getElementById('iner').addEventListener('click', function() {
//    // Change the URL to the desired page
//    window.location.href = 'intern2.jsp';
//    
//});
